        ...
        <div class="form-newbill-container content-inner">
          <form data-testid="form-new-bill">
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <!-- Adding accept attribute to prevent user from loading files that are not images -->
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="col-half">
                  <button data-testId="submit-btn" type="submit" id='btn-send-bill' class="btn btn-primary">Envoyer</button>
                </div>
              </div>
            </div>
          </form>
